        ...
        <div className="flex xl:flex-row flex-col  py-12 justify-between gap-9">
          <div className="flex flex-col gap-10 ">
            ...
            <div className="flex md:flex-row flex-col gap-[21px]">
              <ButtonComponent
                rightIcon={<RightIcon />}
                styles="flex  gap-2.5 items-center px-8 h-[60px] bg-[#EF001C] md:w-auto xs:w-[270px] sm:w-[350px]  font-bold rounded-[34px] text-white xs:text-xs sm:text-sm md:text-sm xl:text-base"
              >
